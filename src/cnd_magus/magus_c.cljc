...
(s/def :character/x int?)
(s/def :character/y int?)
(s/def :character/strength int?)
(s/def :character/wisdom int?)
(s/def :character/skill int?)
(s/def :character/health int?)
(s/def :character/power int?)
(s/def :character/maxHealth int?)
(s/def :character/maxPower int?)
(s/def :character/canWalk int?)
(s/def :character/xp int?)
(s/def :character/level int?)
(s/def :character/wearing (s/coll-of any?))
(s/def :character/wielding (s/coll-of any?))
(s/def :character/carrying (s/coll-of any?))
(s/def :character/lifeSpan nat-int?)
...
(s/def :character/confused? boolean?)
(s/def :character/isPlayer boolean?)
(s/def :character/isFleeing boolean?)
